  ...
  return (
    <div className="ml-8 mr-6 flex-grow justify-center  hidden xl:flex ">
          <div className="bg-white max-w-lg p-5 h-max shadow-md mt-24 hover:shadow-lg">
            ...
            <img
              className="my-5 pt-5"
              src={data?.playlist_img}
              alt=""
            />
            <div className="font- text-gray-600">{data.review} ★ · ({data.review_number} review)</div>
            <div className="font- text-gray-600">{data.views.split(" ")[0]} youtube views</div>
