...
function Finalizing({ data }) {
  ...
  return (
    <div className="bg-black h-screen w-screen bg-opacity-20 flex flex-col items-center justify-center overflow-auto">
      <div className="bg-white w-[700px] min-h-[750px] max-h-full flex flex-col  shadow-md p-10 pb-0">
        <div className="text-2xl font-bold">
          <a className="text-acc">Y</a>Courses
        </div>


        <div className="md:px-20 flex flex-col gap-12 my-auto py-20 overflow-auto">
  ...
  return (
    <div className="bg-black h-screen w-screen bg-opacity-20 flex flex-col items-center justify-center overflow-auto">
      <div className="bg-white w-[700px] min-h-[750px] max-h-screen flex flex-col flex-shrink shadow-md p-10 pb-0">
        <div className="text-2xl font-bold">
          <a className="text-acc">Y</a>Courses
        </div>
